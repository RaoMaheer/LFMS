...
import {
  Mail, Phone, Scale, ShieldCheck,
  MapPin, Award, Star, Briefcase, Hash
} from 'lucide-react';
...
const Lawyers = () => {
  ...
  return (
    <div
      ...
      style={{
        background: 'radial-gradient(circle at top right, rgba(251,191,36,0.08), transparent 25%), linear-gradient(135deg, #0f172a, #111827, #020617)',
      }}
    >
      {/* HEADER */}
      <div className="d-flex flex-column flex-lg-row justify-content-between align-items-start align-items-lg-end gap-4 mb-5">
        <div>
          ...
          <h1 className="fw-bolder text-white" style={{ fontSize: 'clamp(2.2rem, 6vw, 3.8rem)', lineHeight: '1' }}>
            Legal Dream Team
          </h1>
          <p className="text-white-50 mt-3" style={{ maxWidth: '650px', fontSize: 'clamp(0.9rem, 2vw, 1.05rem)' }}>
        ...
        <div
          ...
          style={{ background: 'rgba(255,255,255,0.04)', backdropFilter: 'blur(10px)', maxWidth: '320px' }}
        >
          <div className="d-flex align-items-center gap-3">
            ...
            <div>
              <h5 className="text-white fw-bold mb-0">{lawyers.length} Lawyers</h5>
              <small className="text-white-50">Active Partners</small>
            </div>
          </div>
        </div>
      </div>
      ...
      {/* LOADING */}
      {loading && <div className="text-center text-white mt-5">Loading lawyers...</div>}
              ...
              >
                ...
                <div
                  ...
                  style={{
                    ...
                    top: '-100px', right: '-100px', filter: 'blur(50px)',
                  }}
                />

                <div className="p-3 p-md-4 position-relative">

                  {/* LAWYER ID BADGE — top right corner */}
                  ...
                  <div className="d-flex flex-column flex-sm-row align-items-center align-items-sm-start gap-4 mb-4 text-center text-sm-start">
                    ...
                    <div className="position-relative flex-shrink-0">
                      <img
                        ...
                        alt={lawyer.name}
                        style={{
                          width: '110px', height: '130px', objectFit: 'cover',
                          borderRadius: '24px',
                    ...
                    <div className="flex-grow-1 w-100">
                      ...
                      <h3 className="fw-bold text-white mb-1" style={{ fontSize: 'clamp(1.3rem, 3vw, 1.6rem)' }}>
                        {lawyer.name}
                      </h3>
                      ...
                      <div className="d-flex justify-content-center justify-content-sm-start align-items-center gap-2 mb-3">
                        ...
                        <span className="text-uppercase fw-semibold" style={{ color: '#d1d5db', letterSpacing: '1px', fontSize: '13px' }}>
                      ...
                      >
                        ...
                        <small className="text-white fw-semibold">Senior Partner</small>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="row g-3 mb-4">
                    <div className="col-6">
                      <div className="p-3 rounded-4 text-center h-100"
                        style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.05)' }}>
                        <Briefcase size={22} className="text-warning mb-2" />
                        <h5 className="text-white fw-bold mb-0">{experiences[index % experiences.length]}</h5>
                        <small className="text-white-50">Years</small>
                      </div>
                    </div>
                    <div className="col-6">
                      <div className="p-3 rounded-4 text-center h-100"
                        style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.05)' }}>
                        <Award size={22} className="text-warning mb-2" />
                        <h5 className="text-white fw-bold mb-0">{successRates[index % successRates.length]}</h5>
                        <small className="text-white-50">Success</small>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="d-flex flex-column gap-3">
                    ...
                    <div className="d-flex align-items-center gap-3 p-3 rounded-4 flex-wrap"
                      style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.05)' }}>
                      ...
                      <div className="text-break">
                        <small className="text-white-50">Email Address</small>
                        <p className="text-white mb-0 fw-medium small">{lawyer.email}</p>
                      </div>
                    </div>
                    ...
                    <div className="d-flex align-items-center gap-3 p-3 rounded-4 flex-wrap"
                      ...
                      <div>
                        <small className="text-white-50">Contact Number</small>
                        <p className="text-white mb-0 fw-medium">{lawyer.phone}</p>
                      </div>
                    </div>
                    ...
                    <div className="d-flex align-items-center gap-3 p-3 rounded-4 flex-wrap"
                      ...
                      <div>
                        <small className="text-white-50">Office Branch</small>
                        <p className="text-white mb-0 fw-medium small">
                          {californiaBranches[index % californiaBranches.length]}
                        </p>
                      </div>
                    </div>
