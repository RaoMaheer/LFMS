    ...
    <div className="min-vh-100 p-4 p-lg-5 text-white" style={{ background: '#0b1220' }}>
      ...
      <div className="row g-3 mb-4">
        {[
          ...
          { label: 'Searched Results', value: filteredClients.length,                                 color: '#a78bfa', bg: 'rgba(139,92,246,0.1)'  },
        ].map((s) => (
              ...
              {filteredClients.length > 0 ? filteredClients.map((client) => (
                ...
                >
                  ...
                  <td className="px-3 py-3">
                    <div className="d-flex align-items-center gap-2 mb-1 small text-white-50">
                  ...
                  {/* ADDRESS */}
                  <td className="px-3 py-3 small text-black">
                    {client.address}
                  </td>
